...
class Agents:
    ...
    def _append_buffer_sample(self):
        self.sample_buffer[0][2] += self.sample_buffer[1][2] * self.additional_reward_rate + self.sample_buffer[3][2]
        self.sample_buffer[1][2] += self.sample_buffer[3][2]
        self.sample_buffer[2][2] += self.sample_buffer[3][2]
...
if __name__ == '__main__':
    env = MyTGym(episode_type='0', percent_goal_profit=2, percent_stop_loss=5, episode_duration_min=13)
